...
if __name__ == '__main__':
    ...
    parser.add_argument('-cfg', '--cfg', type=str, default='demo.yaml', help="A relative path of the .yaml proj config file.")
    ...
    parser.add_argument('-s', '--save_path', type=str, default='./results/test', help="Path to save the adversarial patch.")
