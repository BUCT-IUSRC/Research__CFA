...
from attack.attacker import CFAUniversalAttacker
...
if __name__ == '__main__':
    ...
    parser.add_argument('-cfg', '--cfg', type=str, default='advpatch/cfa.yaml', help="A relative path of the .yaml proj config file.")
    parser.add_argument('-n', '--board_name', type=str, default='cfa', help="Name of the Tensorboard as well as the patch name.")
    parser.add_argument('-d', '--debugging', action='store_true', help="Will not start tensorboard process if debugging=True.")
    parser.add_argument('-s', '--save_path', type=str, default='./results/cfa', help="Path to save the adversarial patch.")
    ...
    detector_attacker = CFAUniversalAttacker(cfg, device)
